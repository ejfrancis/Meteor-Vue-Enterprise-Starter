...
A password reset has been requested for your account on ${Meteor.settings.public.siteName}. To continue resetting your password please click the following link: ${url.replace('#', '')}
